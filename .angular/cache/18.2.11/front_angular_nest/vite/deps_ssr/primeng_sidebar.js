...
function Sidebar_div_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("ngClass", ɵɵpureFunction6(10, _c1, ctx_r1.visible, ctx_r1.position === "left" && !ctx_r1.fullScreen, ctx_r1.position === "right" && !ctx_r1.fullScreen, ctx_r1.position === "top" && !ctx_r1.fullScreen, ctx_r1.position === "bottom" && !ctx_r1.fullScreen, ctx_r1.fullScreen))("@panelState", ɵɵpureFunction1(20, _c3, ɵɵpureFunction2(17, _c2, ctx_r1.transformOptions, ctx_r1.transitionOptions)))("ngStyle", ctx_r1.style);
    ɵɵattribute("data-pc-name", "sidebar")("data-pc-section", "root")("aria-modal", ctx_r1.modal);
    ɵɵadvance(2);
...
var Sidebar = class _Sidebar {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function Sidebar_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵprojectionDef();
        ɵɵtemplate(0, Sidebar_div_0_Template, 5, 22, "div", 2);
      }
      if (rf & 2) {
