...
var FocusTrap = class _FocusTrap {
  ...
  static ɵfac = function FocusTrap_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _FocusTrap)(ɵɵdirectiveInject(ElementRef));
  };
...
function Dialog_div_0_div_1_ng_template_3_div_1_button_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext(5);
    ɵɵproperty("ngClass", ɵɵpureFunction0(5, _c9));
    ɵɵadvance();
...
function Dialog_div_0_div_1_ng_template_3_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(6, Dialog_div_0_div_1_ng_template_3_div_1_button_6_Template, 5, 6, "button", 19)(7, Dialog_div_0_div_1_ng_template_3_div_1_button_7_Template, 3, 6, "button", 20);
    ɵɵelementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext(4);
...
var Dialog = class _Dialog {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    dependencies: () => [NgClass, NgIf, NgTemplateOutlet, NgStyle, FocusTrap, Ripple, TimesIcon, WindowMaximizeIcon, WindowMinimizeIcon],
