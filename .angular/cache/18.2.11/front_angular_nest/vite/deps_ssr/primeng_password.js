...
var PasswordDirective = class _PasswordDirective {
  ...
  static ɵfac = function PasswordDirective_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _PasswordDirective)(ɵɵdirectiveInject(DOCUMENT), ɵɵdirectiveInject(PLATFORM_ID), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NgZone));
  };
...
var Password = class _Password {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    features: [ɵɵProvidersFeature([Password_VALUE_ACCESSOR])],
    decls: 9,
    vars: 32,
    consts: [["input", ""], ["overlay", ""], ["content", ""], [3, "ngClass", "ngStyle"], ["pInputText", "", 3, "input", "focus", "blur", "keyup", "ngClass", "ngStyle", "value"], [4, "ngIf"], [3, "ngClass", "click", 4, "ngIf"], [3, "styleClass", "click", 4, "ngIf"], [1, "p-password-clear-icon", 3, "click"], [4, "ngTemplateOutlet"], [3, "click", "styleClass"], [3, "click", 4, "ngIf"], [3, "click"], [3, "click", "ngClass"], [4, "ngIf", "ngIfElse"], [1, "p-password-meter"], ["className", "p-password-info"]],
    template: function Password_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        ɵɵproperty("ngClass", ɵɵpipeBind2(1, 23, ctx.toggleMask, ctx.containerClass))("ngStyle", ctx.style);
        ɵɵattribute("data-pc-name", "password")("data-pc-section", "root");
        ɵɵadvance(2);
        ɵɵclassMap(ctx.inputStyleClass);
        ɵɵproperty("ngClass", ɵɵpipeBind2(4, 26, ctx.disabled, ctx.inputFieldClass))("ngStyle", ctx.inputStyle)("value", ctx.value);
        ɵɵattribute("label", ctx.label)("aria-label", ctx.ariaLabel)("aria-labelledBy", ctx.ariaLabelledBy)("id", ctx.inputId)("type", ɵɵpipeBind2(5, 29, ctx.unmasked, ctx.inputType))("placeholder", ctx.placeholder)("autocomplete", ctx.autocomplete)("maxlength", ctx.maxLength)("data-pc-section", "input");
        ɵɵadvance(4);
    ...
    dependencies: () => [NgClass, NgIf, NgTemplateOutlet, NgStyle, InputText, TimesIcon, EyeSlashIcon, EyeIcon, MapperPipe],
